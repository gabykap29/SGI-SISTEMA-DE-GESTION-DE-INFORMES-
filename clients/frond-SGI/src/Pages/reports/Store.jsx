                ...
                <div className="card  shadow">
                  <div className="card-body">
                    <div className=" form-cargar">
                      <form action="" className="row  needs-validation" id="formNuevoInforme" enctype="multipart/form-data">
                          ...
                          <div className="col-md-3 position-relative">
                            ...
                            <div className="mb-1">
                              ...
                              <textarea className="form-control input" id="informe" rows="3" style={{height:"180px"}}></textarea>                
                              
                              <div className="col-12 position-relative">
                                <label for="exampleFormControlTextarea1" className="form-label">Completado</label>
                                <input type="checkbox" className="form-check-input" id="isCompleted" />          
                              </div> 
